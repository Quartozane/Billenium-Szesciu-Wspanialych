...
public class DoctorController {
    ...
    public DoctorController(MongoTemplate mongoTemplate, DoctorCardRepository doctorCardRepository, UserRepository userRepository, PatientCardRepository patientCardRepository, VisitationsRepository visitationsRepository) {
